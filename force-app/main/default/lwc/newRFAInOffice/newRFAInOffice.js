...
export default class NewRFAInOffice extends NavigationMixin(LightningElement) {
    ...
    mapOpportunityDataToFields(oppData) {
        ...
        this.fieldValues.LeaseholdImprovementAllowance = oppData.Leasehold_Improvement_Allowance1__c || '';
    ...
    async handleSubmit() {
        ...
        try {
            ...
            await updateSupervision({
                ...
                leaseholdimprovementallowance: this.fieldValues.LeaseholdImprovementAllowance,
